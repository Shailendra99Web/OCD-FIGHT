    ...
    return (
        <div className='mt-4 min-h-[80vh] flex flex-col justify-evenly item-center space-y-2'>
            <div className='flex flex-col justify-center items-center space-y-2 px-2'>
                ...
                <p className='dark:text-yellow-500 text-center'>Note: All today&apos;s data will be erased including Ocd Counter, All Histories.</p>
            ...
            <div className='flex flex-col justify-center items-center space-y-2 px-2'>
                ...
                <p className='dark:text-red-500 text-center'>Note: All today&apos;s data will be erased including Ocd Counter, All Histories and All Intervals.</p>
